 ...
 * removed in `@arizeai/phoenix-evals` 3.0.0.
 */
 ...
 * `documentText` to `context`. This type will be removed in
 * `@arizeai/phoenix-evals` 3.0.0.
 */
 ...
 * preserve per-document evaluation. This function will be removed in
 * `@arizeai/phoenix-evals` 3.0.0.
 *
